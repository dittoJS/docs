...
export default class HomePage extends Component {
    ...
    render() {
        return ( <
            ...
            <
            h1 className = "" > DittoJs 是一个开放式的跨平台、 框架编译转换工具 < /h1> <
            h2 className = "" > 编写一次， 编译成不同平台、 不同框架的代码 < /h2> <
            ...
            开始使用 <
            /a> <
            a href="https://github.com/dittoJS/ditto" class = "button is-info is-outlined" > Github < /a> <
            /div> <
            /section> <
            ...
            p className = "heading" > 指令式语法， 支持 jsx 模板 < /p> <
            /div> <
            /div> <
            div className = "level-item has-text-centered" >
            <
            ...
            p className = "heading" > 支持组件化开发， 层次清晰， 便于复用 < /p> <
            /div> <
            /div> <
            div className = "level-item has-text-centered" >
            <
            ...
            p className = "heading" > 编写一套代码， 生成不同端、 框架原生代码 < /p> <
            /div> <
            /div> <
            div className = "level-item has-text-centered" >
            <
            ...
            p className = "heading" > 基于插件的编译方式， 定制自己的编译规则 < /p> <
            /div> <
            /div> <
            /nav> <
            /div> <
